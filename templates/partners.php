...
get_header(); ?>
    ...
    <section class="omni">
        <div class="container">
            <div class="block block-article-partners">
                <h2 class="title-page">It's a win-win deal</h2>
    ...
    <section class="omni omni-custom-block">
        <div class="container">
            <div class="block block-slider-product">
                ...
                <div class="slick-slider slick-slider-product">
                    <div class="item"><a href="javascript:void(0)"><img src="<?php echo(get_template_directory_uri()); ?>/inc/images/partners-5.png"></a><a href="javascript:void(0)"><img src="<?php echo(get_template_directory_uri()); ?>/inc/images/trl.png"></a></div>
                    <div class="item"><a href="javascript:void(0)"><img src="<?php echo(get_template_directory_uri()); ?>/inc/images/partners-6.png"></a><a href="javascript:void(0)"><img src="<?php echo(get_template_directory_uri()); ?>/inc/images/awork2.png"></a></div>
                    <div class="item"><a href="javascript:void(0)"><img src="<?php echo(get_template_directory_uri()); ?>/inc/images/partners-7.png"></a><a href="javascript:void(0)"><img src="<?php echo(get_template_directory_uri()); ?>/inc/images/Natsort.png"></a></div>
                    <div class="item"><a href="javascript:void(0)"><img src="<?php echo(get_template_directory_uri()); ?>/inc/images/partners-8.png"></a><a href="javascript:void(0)"><img src="<?php echo(get_template_directory_uri()); ?>/inc/images/LMT.png"></a></div>
                    <div class="item"><a href="javascript:void(0)"><img src="<?php echo(get_template_directory_uri()); ?>/inc/images/partners-9.png"></a><a href="javascript:void(0)"><img src="<?php echo(get_template_directory_uri()); ?>/inc/images/Makers.png"></a></div>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <!--<div class="col-md-8 col-md-offset-2">
                        <div class="trial-content-main custom-contact custom-block-2">
                            ...
                            <form action="javascript:void(0)">
                                ...
                                <div class="row custom-row-3">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control" type="text" placeholder="Company website">
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="row custom-row-3">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control">
                                            ...
                                            <option>Field of expertise 2</option>
                                            <option>Field of expertise 3</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control">
